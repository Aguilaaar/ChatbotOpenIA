...
assistente_id = assistente["assistent_id"]
    ...
    while True:
        try:
            ...
            if caminho_imagem_enviada != None:
                ...
                resposta_vision+= " Na resposta final, apresente detalhes da descrição da imagem, antes das instruções de como o usuário deve proceder."
            ...
            resposta = historico[0].content[0].text.value
            return resposta
            ...
            if repeticao >= maximo_tentativas:
                return f"Erro ao tentar acessar o GPT: {str(erro)}"
